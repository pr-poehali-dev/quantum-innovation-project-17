            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-base font-light text-white/60 md:text-lg max-w-md">
                  Устали от боли в спине и шее? Чувствуйте напряжение в мышцах после рабочего дня? Профессиональный лечебный массаж поможет снять мышечные спазмы, улучшить кровообращение, избавиться от хронической усталости.
                </p>
